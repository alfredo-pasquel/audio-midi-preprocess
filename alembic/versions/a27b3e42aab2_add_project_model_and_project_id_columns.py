"""Add Project model and project_id columns

Revision ID: a27b3e42aab2
Revises: 1f80885df36d
Create Date: 2025-02-05 16:05:06.484501
...
revision: str = 'a27b3e42aab2'
down_revision: Union[str, None] = '1f80885df36d'
...
def upgrade() -> None:
    ...
    sa.Column('feature_data', sa.Text(), nullable=True),
